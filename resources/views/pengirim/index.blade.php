...
<div class="sidebar">
    ...
    <div class="p-4 text-center border-bottom border-secondary">
        <h5 class="fw-bold m-0 text-white">
            KOPI <span style="color: var(--gold-accent)">NTT</span>
        </h5>
    ...
    <div class="py-4">
        ...
        <a href="{{ route('pengirim.index') }}"
           class="nav-link {{ Route::is('pengirim.index') ? 'active' : '' }}">

            <i class="bi bi-grid-1x2-fill me-2"></i>
            Dashboard Kerja
        </a>

        <a href="{{ route('pengirim.history') }}"
           class="nav-link {{ Route::is('pengirim.history') ? 'active' : '' }}">
...
<div class="main-content">
    ...
    <!-- VALIDATION ERROR -->
    @if($errors->any())
        <div class="alert alert-warning alert-dismissible fade show shadow-sm border-0 rounded-4">
    ...
    <div class="row">
            ...
            <div class="col-md-6 mb-4">
                ...
                <div class="card task-card border-0 shadow-sm p-4">
                    ...
                    <h6 class="fw-bold mb-1 text-dark">
                        ...
                        {{ $order->nama_penerima ?? ($order->user->name ?? 'Pelanggan') }}
                    ...
                    <p class="text-muted small mb-4">
                        ...
                        {{ $order->alamat_pengiriman ?? ($order->user->alamat ?? '-') }}

                    </p>

                    <!-- FORM KONFIRMASI -->
                    <form action="{{ route('pengirim.konfirmasi', $order->id) }}"
                          method="POST"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file"
                                   ...
                                   required
                                   onchange="previewImage(event, 'preview{{ $order->id }}')">
                            ...
                            <!-- PREVIEW -->
                            <img id="preview{{ $order->id }}"
                                 class="preview-image">
                        </div>

                        <button type="submit"
                                class="btn btn-konfirmasi w-100 py-2 shadow-sm">
        ...
        @empty
            ...
            <div class="col-12 text-center py-5">
                ...
                <p class="text-muted">
                    Luar biasa! Tidak ada tugas pengiriman tersisa hari ini.
                </p>
